...
//        System.out.printf("My sentence : %s%n", sentence);

//        Instructor Solution: This will only capture up until the first space so will not capture the whole sentence. Good to capture one word.
